...
export class MonsterComponent implements OnInit, OnDestroy {
  ...
  private routeSubscription: Subscription | null = null             // observe le changement de param id
  private formValuesSubscription: Subscription | null = null        // observe le changement de valeurs du form
